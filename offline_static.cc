...
main(int argc, char* argv[])
{
    ...
    // onOffHelper.SetAttribute("OnTime", TimeValue(Seconds(interPacketInterval)));
    // onOffHelper.SetAttribute("OffTime", TimeValue(Seconds(0.0))); // No Off interval, as we want a continuous traffic flow
